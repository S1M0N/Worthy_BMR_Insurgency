player createDiaryRecord ["Diary", ["3rd Party Credits","
	...
	<br />	BTC_main_load_VAS, BTC_load_VAS by BTC
...
player createDiaryRecord ["Diary", ["Credits","
	...
	<br />Several functions and scripts by BTC and Ghost
...
player createDiaryRecord ["Diary", ["INFO","
	...
	<br />
	-------------------
	<br />Press U key for Graphic Settings, Digital Heading and HUD. Squads are set in lobby but can be altered by holding T Key Schroll. Use target cursor to select players. Supported PIP livefeeds from the helmet-cameras of their fellow group members. Requires Tactical Glasses. * - Activates camera / switches to next groupmember. Alt+* - Deactivates camera. Shift+* - Toggles size of the display.
	<br />
	-------------------  
	<br />-- Support --
	<br />
	-------------------
	<br />JTAC and Team leader CAS1 can call for Close Air Support. UAV Operators can call for air dropped UGV and launch parachute camera by firing a white flare from 203 grenade launcher. Engineer can build a FARP to repair and rearm vehicles if he has a Bobcat or Repair Truck close by. Medics can buid a small sandbag wall to provide cover. Team Leader CAS1 can call for squad heli evac. Sniper, Marksmen and Spotter classes can enable/dissable bullet cam.
	<br />
	-------------------
	<br />-- Vehicles --
	<br />
	-------------------
	<br />Vehicles from base will respawn if destroyed. All Mobile Head Quarters have VAS. The Bobcat can Tow other vehicles. GhostHawks can lift light vehicles. Mohawks can lift heavy and light vehicles. Earn an air dropped asset of your choice by destroying an ammo cache.
	<br />
	-------------------
	<br />-- Respawn --
	<br />
	-------------------
	<br />If you die you can choose to respawn at BASE, MHQ_1, MHQ_2, or MHQ_3 if no one revives you. You may also choose teleport to MHQs or Halo from Flag Pole at base. While waiting for a revive you can spectate and control camera with usual movement controlls. Save loadout with Load on Respawn button in VAS.
  "]];
player createDiaryRecord ["Diary", ["Briefing","Gather Intel on Ammo Cache location by picking up suitcases. Destroy Ammo Caches with satchel or demo charges. Clear all red zones of enemy forces. Get Some!"]];