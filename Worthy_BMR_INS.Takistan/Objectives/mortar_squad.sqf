...
sleep 2;
private ["_newZone","_type","_rnum","_range","_run","_mortar_type","_objmkr","_sign","_grp","_stat_grp","_handle","_unit_type","_damage","_offset_pos1","_static1","_offset_pos2","_static2","_offset_pos3","_static3","_StaticArray1","_all_mortars","_tskW","_tasktopicW","_taskdescW","_tskE","_tasktopicE","_taskdescE","_manArray"];
