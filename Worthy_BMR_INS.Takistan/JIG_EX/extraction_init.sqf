...
JIG_EX_Caller = 		{PL,SL1,SL2,RSL};							// Name of playable unit in editor who can call in Extraction Via scroll action, ie; s1, TeamLeader or TL1. This edit is required at the very least to run script pack.
...
JIG_EX_Despawn_Time	= 	45;								// Delete Chopper timer. Starts after chooper reaches destination and caller's group dissembarks. Action does not return until this completes or choper destroyed.
