...
mhq_actions_fnc = {
	// Add action for VAS and quick VAS profile to respawned MHQs. by Jigsor
	private ["_veh","_var"];
	...
	switch (true) do {
		case (_var isEqualTo "MHQ_1") : {_veh addAction [("<t color=""#F56618"">") + ("Load VAS profile") + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[],BTC_MHQ1_load_VAS], 1, true, true, "", "true"]; _veh addAction["<t color='#ff1111'>Virtual Ammobox</t>", "VAS\open.sqf"];};
		case (_var isEqualTo "MHQ_2") : {_veh addAction [("<t color=""#F56618"">") + ("Load VAS profile") + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[],BTC_MHQ2_load_VAS], 1, true, true, "", "true"]; _veh addAction["<t color='#ff1111'>Virtual Ammobox</t>", "VAS\open.sqf"];};
		case (_var isEqualTo "MHQ_3") : {_veh addAction [("<t color=""#F56618"">") + ("Load VAS profile") + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[],BTC_MHQ3_load_VAS], 1, true, true, "", "true"]; _veh addAction["<t color='#ff1111'>Virtual Ammobox</t>", "VAS\open.sqf"];};
...
BTC_MHQ1_load_VAS = {
	// add quick VAS profile to MHQ_1
	for "_i" from 0 to 15 do {
		if (!isNil {profileNameSpace getVariable format ["vas_gear_new_%1",_i]}) then
		{
			_i spawn
			{
				_id = MHQ_1 addAction [("<t color=""#00ffe9"">") + ("Load " + format ["%1",(profileNameSpace getVariable format ["vas_gear_new_%1",_this]) select 0]) + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[format ["vas_gear_new_%1",_this]],BTC_load_VAS], 8, true, true, "", "true"];
				sleep 15;
...
BTC_MHQ2_load_VAS = {
	// add quick VAS profile to MHQ_2
	for "_i" from 0 to 15 do
	{
		if (!isNil {profileNameSpace getVariable format ["vas_gear_new_%1",_i]}) then
		{
			_i spawn
			{
				_id = MHQ_2 addAction [("<t color=""#00ffe9"">") + ("Load " + format ["%1",(profileNameSpace getVariable format ["vas_gear_new_%1",_this]) select 0]) + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[format ["vas_gear_new_%1",_this]],BTC_load_VAS], 8, true, true, "", "true"];
				sleep 15;
...
BTC_MHQ3_load_VAS = {
	// add quick VAS profile to MHQ_3
	for "_i" from 0 to 15 do {
		if (!isNil {profileNameSpace getVariable format ["vas_gear_new_%1",_i]}) then
		{
			_i spawn
			{
				_id = MHQ_3 addAction [("<t color=""#00ffe9"">") + ("Load " + format ["%1",(profileNameSpace getVariable format ["vas_gear_new_%1",_this]) select 0]) + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[format ["vas_gear_new_%1",_this]],BTC_load_VAS], 8, true, true, "", "true"];
				sleep 15;
