...
ASORGS_medical = ["ACE_fieldDressing","ACE_bloodIV","ACE_epinephrine","ACE_morphine"];

//Items that for some reason get detected as something else (minedetector = launcher?). Forces them into Misc.
ASORGS_forceMisc = ["MineDetector", "ACE_SpareBarrel", "ACE_Altimeter", "ACE_MapTools", "ACE_UAVBattery", "ACE_wirecutter", "ToolKit", "ACE_Kestrel4500", "ACE_Clacker","ACE_DefusalKit", "ACE_Cellphone", "ACE_DeadManSwitch", "ACE_M26_Clacker", "ACE_CableTie"];
