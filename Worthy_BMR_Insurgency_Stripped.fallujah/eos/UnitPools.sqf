...
switch (_faction) do {
	...
	_heliCrew=	["MEC_SAA_Rifleman","MEC_SAA_MachineGunner","MEC_SAA_RPG7Soldier","MEC_SAA_AASoldier","MEC_SAA_RPG7Grenadier"];
};
	case 6 : {// Middle Eastern Conflict - Quds Force
	_InfPool=	["MEC_QUD_Rifleman","MEC_QUD_SquadLeader","MEC_QUD_MachineGunner","MEC_QUD_AutomaticRifleman","MEC_QUD_Grenadier","MEC_QUD_ATSoldier","MEC_QUD_AASoldier","MEC_QUD_Medic","MEC_QUD_Marksman","MEC_QUD_Crewman","MEC_QUD_RPG7Grenadier","MEC_QUD_Repair","MEC_QUD_Engineer","MEC_QUD_Explosives","MEC_QUD_Officer","MEC_QUD_Breacher"];
	...
	_crewPool=	["MEC_QUD_Crewman","MEC_QUD_SquadLeader","MEC_QUD_RPG7Grenadier","MEC_QUD_Engineer"];
	...
	_InfPool=	["MEC_IRR_RiflemanO","MEC_IRR_SquadLeaderO","MEC_IRR_MachineGunnerO","MEC_IRR_AutomaticRiflemanO","MEC_IRR_GrenadierO","MEC_IRR_ATSoldierO","MEC_IRR_RPG7SoldierO","MEC_IRR_AASoldierO","MEC_IRR_MedicO","MEC_IRR_MarksmanO","MEC_IRR_CrewmanO","MEC_IRR_RPG7GrenadierO","MEC_IRR_RepairO","MEC_IRR_EngineerO","MEC_IRR_ExplosivesO"];
	...
	_heliCrew=	["MEC_IRR_CrewmanO","MEC_IRR_RPG7GrenadierO","MEC_IRR_MedicO","MEC_IRR_MarksmanO"];
};
	case 8 : {// Middle Eastern Conflict - Taliban
	_InfPool=	["MEC_TAL_AASoldier","MEC_TAL_ATSoldier","MEC_TAL_AutomaticRifleman","MEC_TAL_Crewman","MEC_TAL_Engineer","MEC_TAL_Explosives","MEC_TAL_Grenadier","MEC_TAL_MachineGunner","MEC_TAL_Marksman","MEC_TAL_Medic","MEC_TAL_Repair","MEC_TAL_Rifleman","MEC_TAL_RPG7Grenadier","MEC_TAL_RPG7Soldier","MEC_TAL_SquadLeader"];
	...
	_heliCrew=	["MEC_TAL_Rifleman","MEC_TAL_MachineGunner","MEC_TAL_RPG7Soldier","MEC_TAL_AASoldier","MEC_TAL_RPG7Grenadier"];
};
	case 9 : {// Middle Eastern Conflict - Islamic State
	_InfPool=	["MEC_IS_AASoldier","MEC_IS_ATSoldier","MEC_IS_AutomaticRifleman","MEC_IS_Crewman","MEC_IS_Engineer","MEC_IS_Explosives","MEC_IS_Grenadier","MEC_IS_MachineGunner","MEC_IS_Marksman","MEC_IS_Medic","MEC_IS_Repair","MEC_IS_Rifleman","MEC_IS_RPG7Grenadier","MEC_IS_RPG7Soldier","MEC_IS_SquadLeader"];
	...
	_heliCrew=	["MEC_IS_Rifleman","MEC_IS_MachineGunner","MEC_IS_RPG7Soldier","MEC_IS_AASoldier","MEC_IS_RPG7Grenadier"];
};
	case 10 : {// Sud Russians
	...
	case 11 : {// CAF Aggressors Middle Eastern
	...
	case 12 : {// CAF Aggressors African pirates
	...
	case 13 : {// CAF Aggressors European Rebels
	...
	case 14 : {// RHS - Armed Forces of the Russian Federation MSV
	...
	_CHPool=	["RHS_Mi8MT_vdv","O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F"];
	_uavPool=	["O_UAV_01_F","O_UAV_02_CAS_F","O_UGV_01_rcws_F"];
	_stPool=	["O_Mortar_01_F","O_HMG_01_high_F","O_static_AT_F","O_static_AA_F"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
