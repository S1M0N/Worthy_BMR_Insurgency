/*
 ...
 Modified by Jigsor. Last Edit 3/14/2014.//Adapted to spawn intel. Modified mostly beginning and ending. The core is by Ghost. Places Intel and creates intel location markers.
*/

if (!isServer) exitWith{};
if (not (EnemyAmmoCache > 0)) exitWith{};
...
{
	private ["_nearBuildings","_all_cache_pos","_intel","_rnum","_intel_types","_veh_name","_VarName","_params_PutinBuild","_position_mark","_intel_coor_selection","_radarray","_unitarray","_markunitsarray","_markunits","_mcolor","_msize","_markunitspos","_jigxcoor","_jigycoor","_intel_coor","_loop","_p","_n","_i","_markname","_mark1","_nul","_unit","_unit1","_mkr_position","_iobj","_current_cache","_total_intelObjs","_hide_intel","_uncaped_eos_mkrs","_current_cache","_debug","_uncaped_mkr_count","_total_intelObjs"];
