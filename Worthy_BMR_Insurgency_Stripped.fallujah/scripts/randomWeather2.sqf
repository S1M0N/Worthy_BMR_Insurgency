...
_startingdate = [2015, 05, 28, BTC_p_time, 00];
...
weatherTemplates = [
        ...
        ["Light Rain",[1,2,3,5],[0.60,0,0.05,3,3]],
        ["Medium Rain",[2,3,4],[0.70,0,0.05,4,4]],
        ["Rainstorm",[3],[0.80,0,0.1,5,5]],
...
// Check if there is no ParamsArray, and pick random if so, otherwise pick from paramsArray.
	...
	*/
	rw2_Current_Weather = 0;//Jig changed default
